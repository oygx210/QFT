function [P]=addtmpl(P1,P2,typ)
% ADDTMPL Addition of two LTI/FRD arrays.
%         ADDTMPL(P1,P2,FLAG) produces the user-specified addition of P1 and P2.
%         FLAG = 1 for correleated; FLAG = 2 for uncorrelated.
%
...
%
%         See also MULTMPL, CLTMPL.

% Author: Craig Borghesani
% 8/31/93
% 7/3/03 9:55AM : Updated for LTI support.
% Copyright (c) 2003, Terasoft, Inc.

if ~isa(P1,'lti'),
   error('ADDTMPL only for LTI arrays.');
end
