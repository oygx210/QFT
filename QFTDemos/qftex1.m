...
w = [.1,5,10,100]; % working frequencies
...
W2=tf(0.02*[1,64,748,2400],[1,14.4,169]);% upper and lower weights
...
disp(' ')
disp('bdb3=sisobnds(3,wbd3,W3,P,R,nompt); %input disturbance rejection')
drawnow
wbd3=[.1,5,10]; % performance frequency range
W3 = 0.01;% weight
bdb3 = sisobnds(3,wbd3,W3,P,R,nompt);
